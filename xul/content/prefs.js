...
function initPrefs()
{
    ...
    var prefs =
        [
         ...
         ["autoLineMarker",     true,     "appearance.misc"],
         ...
         ["motif.current",      "chrome://ambassador/skin/output-light.css",
                                          "appearance.motif"],
         ["motif.dark",         "chrome://ambassador/skin/output-dark.css",
                                          "appearance.motif"],
         ["motif.light",        "chrome://ambassador/skin/output-light.css",
                                          "appearance.motif"],
         ...
         ["outputWindowURL",   "chrome://ambassador/content/output-window.html",
                                          "hidden"],
...
function getNetworkPrefManager(network)
{
    ...
    var prefs =
        [
         ...
         ["autoLineMarker",   defer, "appearance.misc"],
